...
global.authFile = `TSession`
global.authFileJB = `TJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['The-SimpleBot-MDV2', 'Edge', '2.0.0'] : methodCodeQR ? ['Yesith-FB-Bot MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
