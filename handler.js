...
"thumbnail": apii.data, 
"title": [wm, packname, 'Yesith-FB-Bot MD'].getRandom(),
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: packname, body: '°Hola que tal°' + nombre, thumbnail: yoshiImg, sourceUrl: 'https://whatsapp.com/channel/0029Vae0xVBHwXb4iANXGt1m'}}}}, aa);
